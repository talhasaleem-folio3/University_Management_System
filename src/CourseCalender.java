...
public class CourseCalender {
	...
	File calenderFile = new File("C:/eclipse/Workspace/UMSFiling/src/CourseCalender.txt");
	...
	CourseCalender(String day, String startTime, String endTime, String courseId, String endDay, String tutorName){
	...
	void viewCourseCalender(){
		System.out.println(" ID \t\t AT \t TILL \t FROM \t\t TO//AND \t  TUTOR");
	...
	void modifyCourseCalender(){
		...
		while(in.hasNextLine()){
			...
			if(id.compareToIgnoreCase(info) == 0){
				...
				System.out.print("Enter Starting Time to modify: ");
				...
				System.out.print("Enter Tutor name to modify: ");
				this.tutorName = input.nextLine();
				
				write.println(courseId + " " + startTime + " " + endTime + " " + day + " " + endDay + " " + tutorName);
				flag = 1;
				System.out.println("Course Calender Modification completed.");
			} else{
